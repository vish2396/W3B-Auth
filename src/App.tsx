...
const clientId = "BLhOcBvogrrszabTgF3OQipU9Hx-ImbH-JRpJ9aTAKFbfsbOLkeZiN5SVVxiMPfheB6bhsWWfHOnUYPEQGXplhI"; // get from https://dashboard.web3auth.io
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a href="http://blockchain-tech.asia" target="_blank" rel="nooperner noreferrer">
